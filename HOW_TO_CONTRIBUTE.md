# Contributing to PinkVariable
### Welcome! 👋
This is the official guide on how to contribute to PinkVariable. We want to make it as easy as possible to contribute, so if you have any questions or comments, reach out via GitHub issues!

There are a few ways to contribute:

- 💫 Complete items on the [Roadmap](https://github.com/Mbstudio101/PinkVariable/projects).
- 💡 Make suggestions in [GitHub Discussions](https://github.com/Mbstudio101/PinkVariable/discussions).
- 🪴 Start new Issues - see [Issues](https://github.com/Mbstudio101/PinkVariable/issues).



### Codebase Guide

We [highly recommend reading this](VOID_CODEBASE_GUIDE.md) guide that we put together on PinkVariable's sourcecode if you'd like to add new features.
...
## Editing PinkVariable's Code

If you're making changes to PinkVariable's code as a contributor, you'll want to run a local version of PinkVariable to make sure your changes worked. Developer mode lets you do this. Here's how to use it.
