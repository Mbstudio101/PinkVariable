/*---------------------------------------------------------------------------------------------
 *  Copyright (c) PinkVariable. All rights reserved.
...
export const config = {
	...
	companyName: 'PinkVariable',
	copyright: 'Copyright (C) 2024 PinkVariable. All rights reserved',
	darwinIcon: 'resources/darwin/pinkvariable.icns',
	darwinBundleIdentifier: product.darwinBundleIdentifier,
	darwinApplicationCategoryType: 'public.app-category.developer-tools',
	darwinHelpBookFolder: 'PinkVariable HelpBook',
	darwinHelpBookName: 'PinkVariable HelpBook',
